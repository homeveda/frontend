...
export default function AddLeadPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(`${backendUrl}/initiallead/req`, payload, {
      ...
      setPopupMessage(error?.response?.data?.message || "Failed to submit form please try again later");
      setPopupColor("red");
      setShowPopup(true);
    } finally {
      setLoading(false);
          ...
          >
            ...
            <div className="mb-4">
              ...
              <textarea
                ...
                value={form.notes}
                onChange={handleChange}
                placeholder="Any additional requirements you want to inform about..."
                rows={3}
                className="mt-2 block w-full rounded-[10px] px-3 py-2 text-sm"
                style={{ border: "1px solid #e9e6e3", backgroundColor: "#fafafa", resize: "vertical" }}
              />
